...
import io.santatube.app.data.OkHttpDownloader
import org.schabi.newpipe.extractor.NewPipe
import org.schabi.newpipe.extractor.localization.ContentCountry
import org.schabi.newpipe.extractor.localization.Localization

class SantaTubeApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        io.santatube.app.data.QualityTargets.configure(this)
    }

    /** Coil singleton: aggressive thumbnail caching — YouTube thumb URLs are immutable. */
    override fun newImageLoader(): ImageLoader =
        ImageLoader.Builder(this)
            .okHttpClient(io.santatube.app.data.Http.client)
            .crossfade(true)
