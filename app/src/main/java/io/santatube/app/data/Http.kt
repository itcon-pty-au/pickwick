...
object Http {
    ...
    private object ResilientDns : Dns {
        ...
        private val executor = Executors.newCachedThreadPool { r ->
            Thread(r, "santatube-dns").apply { isDaemon = true }
        }
        ...
        override fun lookup(hostname: String): List<InetAddress> {
            ...
            val sorted = if (v4.isNotEmpty()) {
                ...
                println("SantaTube: IPv6-only DNS answer for $hostname — fetching IPv4 via DoH")
        ...
        private fun systemWithBudget(hostname: String): List<InetAddress> {
            ...
            return try {
                ...
                task.cancel(true)
                println("SantaTube: system DNS slow/failed for $hostname — using DoH")
